      ...
      try {
        ...
        if (p) {
          setFormData({
            id: p.id,
            name: p.name || '',
            project: p.project || 'Holy Family Township',
            price: p.price?.toString() || '',
            priceLabel: p.priceLabel || '',
            pricePerSqYd: p.pricePerSqYd || '',
            location: p.location || '',
            locality: p.locality || 'Greater Noida',
            type: p.type || 'Residential Plot',
            category: p.category || 'buy',
            area: p.area?.toString() || '',
            areaUnit: p.areaUnit || 'sq.yd.',
            dimensions: p.dimensions || '',
            facing: p.facing || 'East',
            roadWidth: p.roadWidth || '30 ft',
            registryStatus: p.registryStatus || 'Registry Ready',
            developmentStatus: p.developmentStatus || 'Fully Developed',
            possessionStatus: p.possessionStatus || 'Immediate',
            ...
            nearbyPlaces: p.nearbyPlaces ? p.nearbyPlaces.join(', ') : '',
            mapUrl: p.mapUrl || '',
            videoUrl: p.videoUrl || ''
          });
        }
  ...
  return (
    <div>
      <div className="admin-header">
        <h1 className="admin-title">Edit Plot Property</h1>
      </div>
